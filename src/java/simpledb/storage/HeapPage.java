...
public class HeapPage implements Page {
    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
        ...
        try{
        	...
        	//System.out.println("tuples.length: "+tuples.length + " td.size: "+td.getSize()+" getNumTuples:"+getNumTuples()+" getHeaderSize():"+getHeaderSize());
        	//System.out.println("numSlots:"+numSlots+Math.ceil(numSlots / 8.0));
    ...
    public Iterator<Tuple> iterator() {
    	...
    	return new Iterator<Tuple>() {
			...
			public boolean hasNext() {
				//System.out.println(nextSlot+" "+tuples.length+" "+numSlots);
				while(nextSlot < numSlots && !isSlotUsed(nextSlot) )
					nextSlot++;
