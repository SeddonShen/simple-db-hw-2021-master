...
public class HeapPageId implements PageId {
	...
	public int hashCode() {
		// some code goes here
		//System.out.println((""+String.valueOf(tableId).hashCode() +""+ String.valueOf(pgNo).hashCode()).hashCode());
		return (""+String.valueOf(tableId).hashCode() + String.valueOf(pgNo).hashCode()).hashCode();
	...
	public boolean equals(Object o) {
		// some code goes here
		return this.getClass().isInstance(o) ? (tableId == ((HeapPageId) o).tableId ? (pgNo == ((HeapPageId) o).pgNo ? true : false) : false):false;
	}
